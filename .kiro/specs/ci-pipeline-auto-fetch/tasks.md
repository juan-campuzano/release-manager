...
- [ ] 1. Define CIExecution type and extend Release with repositoryConfigId
  - [ ] 1.1 Add `CIExecution` interface and `repositoryConfigId` to domain types
...
- [ ] 2. Implement GitHubAdapter.getWorkflowRuns
  - [ ] 2.1 Add `getWorkflowRuns` method to GitHubAdapter
...
- [ ] 3. Implement AzureDevOpsAdapter.getPipelineBuilds
  - [ ] 3.1 Add `getPipelineBuilds` method to AzureDevOpsAdapter
...
- [ ] 4. Checkpoint — Adapter layer complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement PipelineFetcher service
  - [ ] 5.1 Create `PipelineFetcher` service
...
- [ ] 6. Add pipeline-executions API endpoint and wire PipelineFetcher
  - [ ] 6.1 Add GET `/api/releases/:id/pipeline-executions` endpoint
  ...
  - [ ] 6.2 Register PipelineFetcher in the services container
...
- [ ] 7. Checkpoint — Server-side complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Add frontend CIExecution type and PipelineExecutionService
  - [ ] 8.1 Add `CIExecution` type to frontend types
    - Add the `CIExecution` interface to `packages/web/src/types/index.ts` mirroring the server-side type
    - _Requirements: 4.1_

  - [ ] 8.2 Create `PipelineExecutionService`
...
- [ ] 9. Implement usePipelineExecutions hook
  - [ ] 9.1 Create `usePipelineExecutions` hook
...
- [ ] 10. Implement PipelineExecutionsPanel component
  - [ ] 10.1 Create `PipelineExecutionsPanel` component and styles
...
- [ ] 11. Modify BuildInfoForm and wire PipelineExecutionsPanel into ReleaseDetailPage
  - [ ] 11.1 Update `BuildInfoForm` to show auto-fetch notice
  ...
  - [ ] 11.2 Integrate `PipelineExecutionsPanel` into `ReleaseDetailPage`
